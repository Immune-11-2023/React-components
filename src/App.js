...
import './App.css';
import ImageCat from './Components/Image/Image';
  ...
  return (
    <div className='App'>
      <header className='App-header'>
        ...
        {/* <Text name='Gabi' age={0} /> */}
        {/* <Text name={client.name} age={client.age} /> */}
        <Box>
          <>
            <ImageCat src='https://t4.ftcdn.net/jpg/00/97/58/97/360_F_97589769_t45CqXyzjz0KXwoBZT9PRaWGHRk5hQqQ.jpg' />
            <Label value='text' />
          </>
        </Box>
        <Label value='Otro' />
